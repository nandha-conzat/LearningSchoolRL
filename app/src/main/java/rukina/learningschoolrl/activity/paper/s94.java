 ...
 */
public class s94 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s94_1, s94_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s94);
        mp = new MediaPlayer();
        System.gc();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s94_1 = (RelativeLayout) findViewById(R.id.s94_1);
        s94_2 = (RelativeLayout) findViewById(R.id.s94_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s94_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s94.this);
        ...
        s94_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s94);// create's
