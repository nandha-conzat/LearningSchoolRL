 ...
 */
public class s106 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //views to drop onto
        choice_f1 = (TextView) findViewById(R.id.option_f1);
        ...
        choice_g1 = (TextView) findViewById(R.id.option_g1);
        ...
        option_e3.setOnDragListener(new ChoiceDragListener());
        ...
        //set drag listeners
        choice_f1.setOnTouchListener(new ChoiceTouchListener());
        ...
        choice_g1.setOnTouchListener(new ChoiceTouchListener());
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String a4 = option_e3.getText().toString().trim();
                        String b4 = option_e4.getText().toString().trim();
                        String c4 = option_e5.getText().toString().trim();
                        String d4 = option_e6.getText().toString().trim();
                        String e4 = option_e7.getText().toString().trim();

                        userEntered = "" + a + b + c + d + e + a1 + b1 + c1 + d1 + e1 + f1 + a2 + b2 + c2 + d2 + a3 + b3 + c3 + d3 + e3 + a4 + b4 + c4 + d4 + e4;
                        if (userEntered.equals("ch.a.ir.pe.n.ci.lbo.o.kta.b.le.pa.p.e.r")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s106.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s106);// create's
