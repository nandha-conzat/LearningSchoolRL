 ...
 */
public class s105 extends AppCompatActivity {

    ImageView drag, next, back, home, s105_3, s105_4, s105_5, s105_6, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s105);

        mp = new MediaPlayer();
        playTitle();

        s105_3 = (ImageView) findViewById(R.id.s105_3);
        s105_4 = (ImageView) findViewById(R.id.s105_4);
        s105_5 = (ImageView) findViewById(R.id.s105_5);
        s105_6 = (ImageView) findViewById(R.id.s105_6);
        ...
        s105_3.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s105_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s105_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s105.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();

                empty.setImageResource(R.drawable.s105_5);
                try {
        ...
        s105_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s105);// create's
