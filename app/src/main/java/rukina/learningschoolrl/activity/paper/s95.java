 ...
 */
public class s95 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s95_1, s95_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s95);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s95_1 = (RelativeLayout) findViewById(R.id.s95_1);
        s95_2 = (RelativeLayout) findViewById(R.id.s95_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s95_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass(s95.this);
        ...
        s95_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s95);// create's
