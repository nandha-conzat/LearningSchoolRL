 ...
 */
public class s91 extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3 = menu.findItem(R.id.menu_paper);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s91);// create's
