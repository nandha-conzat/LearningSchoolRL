package rukina.learningschoolrl.activity.paper;
 ...
 */
public class s99 extends AppCompatActivity {

    ImageView next, s99_2, s99_3, s99_4, s99_5, s99_6, s99_7, back, home, drag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s99);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.s99_1);
        s99_2 = (ImageView) findViewById(R.id.s99_2);
        s99_3 = (ImageView) findViewById(R.id.s99_3);
        s99_4 = (ImageView) findViewById(R.id.s99_4);
        s99_5 = (ImageView) findViewById(R.id.s99_5);
        s99_6 = (ImageView) findViewById(R.id.s99_6);
        s99_7 = (ImageView) findViewById(R.id.s99_7);
        ...
        s99_7.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s99.this);
        ...
        s99_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s99_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s99_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s99_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s99_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s99);// create's
