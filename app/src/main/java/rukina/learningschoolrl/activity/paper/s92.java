 ...
 */
public class s92 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s92_1, s92_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s92_1 = (RelativeLayout) findViewById(R.id.s92_1);
        s92_2 = (RelativeLayout) findViewById(R.id.s92_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s92_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass(s92.this);
        ...
        s92_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s92);// create's
