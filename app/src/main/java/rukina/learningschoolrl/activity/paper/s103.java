 ...
 */
public class s103 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, s103_1, s103_2, s103_3, s103_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s103);
        mp = new MediaPlayer();
        playTitle();

        s103_1 = (TextView) findViewById(R.id.s103_1);
        s103_2 = (TextView) findViewById(R.id.s103_2);
        s103_3 = (TextView) findViewById(R.id.s103_3);
        s103_4 = (TextView) findViewById(R.id.s103_4);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s103_1.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s103_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass(s103.this);
        ...
        s103_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s103_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s103);// create's
