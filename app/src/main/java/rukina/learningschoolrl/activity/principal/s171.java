 ...
 */
public class s171 extends AppCompatActivity {

    ImageView next, s171_1, s171_2, s171_3, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s171);

        mp = new MediaPlayer();
        playTitle();

        s171_1 = (ImageView) findViewById(R.id.s171_1);
        s171_2 = (ImageView) findViewById(R.id.s171_2);
        s171_3 = (ImageView) findViewById(R.id.s171_3);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s171_1.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s171_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s171.this);
        ...
        s171_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s171);// create's
