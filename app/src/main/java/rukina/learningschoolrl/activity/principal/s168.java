 ...
 */
public class s168 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, drag, s168_2, s168_3, s168_4, s168_5, s168_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s168);

        mp = new MediaPlayer();
        playTitle();

        drag = (TextView) findViewById(R.id.s168_1);
        s168_2 = (TextView) findViewById(R.id.s168_2);
        s168_3 = (TextView) findViewById(R.id.s168_3);
        s168_4 = (TextView) findViewById(R.id.s168_4);
        s168_5 = (TextView) findViewById(R.id.s168_5);
        s168_6 = (TextView) findViewById(R.id.s168_6);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s168_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s168.this);
        ...
        s168_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s168_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s168_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s168_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s168);// create's
