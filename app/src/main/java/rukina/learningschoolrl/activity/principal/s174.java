 ...
 */
public class s174 extends AppCompatActivity {

    ImageView drag, next, back, home, s174_3, s174_4, s174_5, s174_6, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s174);

        mp = new MediaPlayer();
        playTitle();

        s174_3 = (ImageView) findViewById(R.id.s174_3);
        s174_4 = (ImageView) findViewById(R.id.s174_4);
        s174_5 = (ImageView) findViewById(R.id.s174_5);
        s174_6 = (ImageView) findViewById(R.id.s174_6);
        ...
        s174_3.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s174_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s174_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s174.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                empty.setImageResource(R.drawable.s174_6);
                try {
        ...
        s174_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s174);// create's
