 ...
 */
public class s169 extends AppCompatActivity {
    ...
    public void playTitle1() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s169_1);// create's
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s169_big_rock);// create's
        mp.start(); // starting mediaplayer
    }
