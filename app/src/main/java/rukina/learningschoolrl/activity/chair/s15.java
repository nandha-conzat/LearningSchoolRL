...
public class s15 extends AppCompatActivity {
    ...
    TextView dispaly, s15_1, s15_2, s15_3, s15_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s15);
        System.gc();

        mp = new MediaPlayer();
        playTitle();

        s15_1 = (TextView) findViewById(R.id.s15_1);
        s15_2 = (TextView) findViewById(R.id.s15_2);
        s15_3 = (TextView) findViewById(R.id.s15_3);
        s15_4 = (TextView) findViewById(R.id.s15_4);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s15_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s15.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s15);// create's
