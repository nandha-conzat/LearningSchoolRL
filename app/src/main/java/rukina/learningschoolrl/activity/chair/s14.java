...
public class s14 extends AppCompatActivity {
    ...
    ImageView next, back, home, s14_1, s14_2, s14_3;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s14);
        System.gc();

        mp = new MediaPlayer();
        playTitle();

        s14_1 = (ImageView) findViewById(R.id.s14_1);
        s14_2 = (ImageView) findViewById(R.id.s14_2);
        s14_3 = (ImageView) findViewById(R.id.s14_3);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s14.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s14);// create's
