...
public class s11 extends AppCompatActivity {
    ...
    RelativeLayout s11_1, s11_2, s11_3, s11_4;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s11_1 = (RelativeLayout) findViewById(R.id.rl_s11_1);
        s11_2 = (RelativeLayout) findViewById(R.id.rl_s11_2);
        s11_3 = (RelativeLayout) findViewById(R.id.rl_s11_3);
        s11_4 = (RelativeLayout) findViewById(R.id.rl_s11_4);
        ...
        s11_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s11.this);
        ...
        s11_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s11_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s11_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s11);// create's
