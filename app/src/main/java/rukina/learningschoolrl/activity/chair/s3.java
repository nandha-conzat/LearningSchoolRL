...
public class s3 extends AppCompatActivity {
    ...
    LinearLayout s1_1, s1_2, s1_3, s1_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = new MediaPlayer();
        s1_1 = (LinearLayout) findViewById(R.id.s1_1);
        s1_2 = (LinearLayout) findViewById(R.id.s1_2);
        s1_3 = (LinearLayout) findViewById(R.id.s1_3);
        s1_4 = (LinearLayout) findViewById(R.id.s1_4);
        ...
        s1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s3_1);// create's
        ...
        s1_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s3_2);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s1_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s3_3);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s1_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s3_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_chair);
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s3_5);// create's
        mp.start(); // starting mediaplayer
    }
