...
public class s9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s9_1 = (RelativeLayout) findViewById(R.id.s9_1);
        s9_2 = (RelativeLayout) findViewById(R.id.s9_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s9_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s9.this);
        ...
        s9_1.setOnDragListener(new View.OnDragListener() {
