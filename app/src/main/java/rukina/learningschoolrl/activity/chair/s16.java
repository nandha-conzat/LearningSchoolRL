...
public class s16 extends AppCompatActivity {
    ...
    ImageView next, s16_1, s16_2, s16_3, s16_4, s16_5, s16_6, s16_7, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s16);
        System.gc();

        mp = new MediaPlayer();
        playTitle();

        s16_1 = (ImageView) findViewById(R.id.s16_1);
        s16_2 = (ImageView) findViewById(R.id.s16_2);
        s16_3 = (ImageView) findViewById(R.id.s16_3);
        s16_4 = (ImageView) findViewById(R.id.s16_4);
        s16_5 = (ImageView) findViewById(R.id.s16_5);
        s16_6 = (ImageView) findViewById(R.id.s16_6);
        s16_7 = (ImageView) findViewById(R.id.s16_7);
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass(s16.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s16);// create's
