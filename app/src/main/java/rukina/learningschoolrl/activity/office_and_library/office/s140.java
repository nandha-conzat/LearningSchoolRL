 ...
 */
public class s140 extends AppCompatActivity {

    ImageView play, next, back, home;
    private MediaPlayer mp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.s140);

        mp = new MediaPlayer();
        System.gc();

        play = (ImageView) findViewById(R.id.rhyme_play);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s140_anowlsat);// create's
