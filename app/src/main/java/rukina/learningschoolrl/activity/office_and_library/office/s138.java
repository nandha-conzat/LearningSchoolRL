 ...
 */
public class s138 extends AppCompatActivity {

    ImageView drag, next, back, home, s138_3, s138_4, s138_5, s138_6, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s138);
        mp = new MediaPlayer();
        playTitle();

        s138_3 = (ImageView) findViewById(R.id.s138_3);
        s138_4 = (ImageView) findViewById(R.id.s138_4);
        s138_5 = (ImageView) findViewById(R.id.s138_5);
        s138_6 = (ImageView) findViewById(R.id.s138_6);
        ...
        s138_3.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s138_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s138_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s138.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                empty.setImageResource(R.drawable.s138_5);
                try {
        ...
        s138_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s138);// create's
