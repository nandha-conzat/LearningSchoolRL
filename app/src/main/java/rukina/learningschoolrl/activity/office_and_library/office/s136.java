 ...
 */
public class s136 extends AppCompatActivity {

    ImageView next, back, home;
    private MediaPlayer mp;
    TextView dispaly, s136_1, s136_2, s136_3, s136_4, s136_5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s136);

        mp = new MediaPlayer();
        playTitle();

        s136_1 = (TextView) findViewById(R.id.s136_1);
        s136_2 = (TextView) findViewById(R.id.s136_2);
        s136_3 = (TextView) findViewById(R.id.s136_3);
        s136_4 = (TextView) findViewById(R.id.s136_4);
        s136_5 = (TextView) findViewById(R.id.s136_5);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s136_2.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s136_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s136.this);
        ...
        s136_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s136_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s136_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s136);// create's
