 ...
 */
public class s151 extends AppCompatActivity {

    ImageView next, back, home;
    TextView s151_1, s151_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s151);

        mp = new MediaPlayer();
        playTitle();

        s151_1 = (TextView) findViewById(R.id.s151_1);
        s151_2 = (TextView) findViewById(R.id.s151_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s151_1.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass(s151.this);
        ...
        s151_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s151);// create's
