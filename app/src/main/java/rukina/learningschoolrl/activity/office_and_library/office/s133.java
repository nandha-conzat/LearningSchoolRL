 ...
 */
public class s133 extends AppCompatActivity {

    ImageView next, home, back;
    private MediaPlayer mp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.s133);
        ...
        wView.loadUrl("file:///android_asset/s133.gif");
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s100);// create's
