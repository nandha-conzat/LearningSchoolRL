 ...
 */
public class s149 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, drag, s149_2, s149_3, s149_4, s149_5, s149_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s149);

        mp = new MediaPlayer();
        playTitle();

        drag = (TextView) findViewById(R.id.s149_1);
        s149_2 = (TextView) findViewById(R.id.s149_2);
        s149_3 = (TextView) findViewById(R.id.s149_3);
        s149_4 = (TextView) findViewById(R.id.s149_4);
        s149_5 = (TextView) findViewById(R.id.s149_5);
        s149_6 = (TextView) findViewById(R.id.s149_6);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s149_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s149.this);
        ...
        s149_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s149_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s149_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s149);// create's
