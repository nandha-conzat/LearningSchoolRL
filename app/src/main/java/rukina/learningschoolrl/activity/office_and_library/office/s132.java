package rukina.learningschoolrl.activity.office_and_library.office;
 ...
 */
public class s132 extends AppCompatActivity {

    ImageView next, s132_2, s132_3, s132_4, s132_5, s132_6, s132_7, back, home, drag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s132);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.s132_1);
        s132_2 = (ImageView) findViewById(R.id.s132_2);
        s132_3 = (ImageView) findViewById(R.id.s132_3);
        s132_4 = (ImageView) findViewById(R.id.s132_4);
        s132_5 = (ImageView) findViewById(R.id.s132_5);
        s132_6 = (ImageView) findViewById(R.id.s132_6);
        s132_7 = (ImageView) findViewById(R.id.s132_7);
        ...
        s132_7.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s132.this);
        ...
        s132_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s132_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s132_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s132_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s132_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s132);// create's
