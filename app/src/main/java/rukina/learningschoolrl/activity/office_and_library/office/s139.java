 ...
 */
public class s139 extends AppCompatActivity {
    ...
    TextView option_a1, option_a2, option_a3, option_a4, option_a5,
            ...
            option_c1, option_c2, option_c3, option_c4, option_c5, option_c6,
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String e = option_a5.getText().toString().trim();
                        ...
                        userEntered = "" + a + b + c + d + e + a1 + b1 + c1 + d1 + e1 + f1;
                        if (userEntered.equals("g.ir.l.s.o.f.f.i.ce.")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s139.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s139);// create's
