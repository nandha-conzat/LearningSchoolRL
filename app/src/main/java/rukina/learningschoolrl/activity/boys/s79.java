 ...
 */
public class s79 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s79_1, s79_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s79);
        mp = new MediaPlayer();
        System.gc();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s79_1 = (RelativeLayout) findViewById(R.id.s79_1);
        s79_2 = (RelativeLayout) findViewById(R.id.s79_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s79_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s79.this);
        ...
        s79_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s79);// create's
