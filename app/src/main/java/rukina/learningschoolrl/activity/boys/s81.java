 ...
 */
public class s81 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s81_1, s81_2, s81_3;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s81);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s81_1 = (RelativeLayout) findViewById(R.id.s81_1);
        s81_2 = (RelativeLayout) findViewById(R.id.s81_2);
        s81_3 = (RelativeLayout) findViewById(R.id.s81_3);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s81_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s81.this);
        ...
        s81_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s81_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s81);// create's
