 ...
 */
public class s75 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s75_2);// create's
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3 = menu.findItem(R.id.menu_boys);
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s75_1);// create's
        mp.start(); // starting mediaplayer
    }
