 ...
 */
public class s78 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s78_1, s78_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s78);
        mp = new MediaPlayer();
        System.gc();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s78_1 = (RelativeLayout) findViewById(R.id.s78_1);
        s78_2 = (RelativeLayout) findViewById(R.id.s78_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s78_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s78.this);
        ...
        s78_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s78);// create's
