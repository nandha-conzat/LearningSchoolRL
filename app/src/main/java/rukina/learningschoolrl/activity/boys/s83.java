package rukina.learningschoolrl.activity.boys;
 ...
 */
public class s83 extends AppCompatActivity {

    ImageView next, s83_2, s83_3, s83_4, s83_5, s83_6, back, home, drag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s83);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.s83_1);
        s83_2 = (ImageView) findViewById(R.id.s83_2);
        s83_3 = (ImageView) findViewById(R.id.s83_3);
        s83_4 = (ImageView) findViewById(R.id.s83_4);
        s83_5 = (ImageView) findViewById(R.id.s83_5);
        s83_6 = (ImageView) findViewById(R.id.s83_6);
        ...
        s83_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s83.this);
        ...
        s83_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s83_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s83_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s83_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s83);// create's
