 ...
 */
public class s76 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s76_1, s76_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s76);
        mp = new MediaPlayer();
        System.gc();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s76_1 = (RelativeLayout) findViewById(R.id.s76_1);
        s76_2 = (RelativeLayout) findViewById(R.id.s76_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s76_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s76.this);
        ...
        s76_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s76);// create's
