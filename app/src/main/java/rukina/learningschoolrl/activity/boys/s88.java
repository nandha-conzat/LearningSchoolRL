 ...
 */
public class s88 extends AppCompatActivity {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String b = choice1.getText().toString().trim();
                        String o = choice2.getText().toString().trim();
                        String y = choice3.getText().toString().trim();
                        String s = choice4.getText().toString().trim();


                        userEntered = "" + b + o + y + s;
                        if (userEntered.equals("b .o .y .s .")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s88.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s88);// create's
