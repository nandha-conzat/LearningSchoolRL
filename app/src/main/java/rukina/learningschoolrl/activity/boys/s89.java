 ...
 */
public class s89 extends AppCompatActivity {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        userEntered = "" + a + b + c + d + a1 + b1 + c1 + d1 + e1 + a2 + b2 + c2 + d2;
                        if (userEntered.equals("b.o.o.kwa.t.e.rb.o.ys.")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s89.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s89);// create's
