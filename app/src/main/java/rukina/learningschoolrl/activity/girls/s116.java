 ...
 */
public class s116 extends AppCompatActivity {

    ImageView next, s116_2, s116_3, s116_4, s116_5, s116_6, back, home, drag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s116);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.s116_1);
        s116_2 = (ImageView) findViewById(R.id.s116_2);
        s116_3 = (ImageView) findViewById(R.id.s116_3);
        s116_4 = (ImageView) findViewById(R.id.s116_4);
        s116_5 = (ImageView) findViewById(R.id.s116_5);
        s116_6 = (ImageView) findViewById(R.id.s116_6);
        ...
        s116_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s116.this);
        ...
        s116_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s116_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s116_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s116_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s116);// create's
