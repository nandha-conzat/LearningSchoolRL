 ...
 */
public class s120 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, s120_1, s120_2, s120_3, s120_4, s120_5, s120_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s120);

        mp = new MediaPlayer();
        playTitle();

        s120_1 = (TextView) findViewById(R.id.s120_1);
        s120_2 = (TextView) findViewById(R.id.s120_2);
        s120_3 = (TextView) findViewById(R.id.s120_3);
        s120_4 = (TextView) findViewById(R.id.s120_4);
        s120_5 = (TextView) findViewById(R.id.s120_5);
        s120_6 = (TextView) findViewById(R.id.s120_6);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s120_1.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        s120_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass(s120.this);
        ...
        s120_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s120_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s120_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s120_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s120);// create's
