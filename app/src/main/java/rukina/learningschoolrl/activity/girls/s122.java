 ...
 */
public class s122 extends AppCompatActivity {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String e2 = option_c5.getText().toString().trim();

                        userEntered = "" + a + b + c + d + a1 + b1 + c1 + d1 + e1 + a2 + b2 + c2 + d2 + e2;
                        if (userEntered.equals("b.oy.s.j.ui.c.eg.i.r.l.s")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s122.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s122);// create's
