 ...
 */
public class s121 extends AppCompatActivity {

    private TextView option1, option2, option3, option4, option5, option6, choice1, choice2, choice3, choice4, choice5;
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String g = choice1.getText().toString().trim();
                        String i = choice2.getText().toString().trim();
                        String r = choice3.getText().toString().trim();
                        String l = choice4.getText().toString().trim();
                        String s = choice5.getText().toString().trim();


                        userEntered = "" + g + i + r + l + s;
                        if (userEntered.equals("g .i .r .l .s .")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s121.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s121);// create's
