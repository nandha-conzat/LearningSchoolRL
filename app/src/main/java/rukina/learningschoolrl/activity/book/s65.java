 ...
 */
public class s65 extends AppCompatActivity {
    ImageView next, back, home;
    LinearLayout drag;
    TextView dispaly, s65_2, s65_3, s65_4, s65_5, s65_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s65);

        mp = new MediaPlayer();
        playTitle();

        drag = (LinearLayout) findViewById(R.id.s65_7);
        s65_2 = (TextView) findViewById(R.id.s65_2);
        s65_3 = (TextView) findViewById(R.id.s65_3);
        s65_4 = (TextView) findViewById(R.id.s65_4);
        s65_5 = (TextView) findViewById(R.id.s65_5);
        s65_6 = (TextView) findViewById(R.id.s65_6);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s65_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s65.this);
        ...
        s65_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s65_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s65_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s65_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s65);// create's
