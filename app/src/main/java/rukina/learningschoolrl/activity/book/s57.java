 ...
 */
public class s57 extends AppCompatActivity {

    private MediaPlayer mp;
    LinearLayout s57_1, s57_2, s57_3, s57_4;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.s57);

        mp = new MediaPlayer();
        s57_1 = (LinearLayout) findViewById(R.id.s57_1);
        s57_2 = (LinearLayout) findViewById(R.id.s57_2);
        s57_3 = (LinearLayout) findViewById(R.id.s57_3);
        s57_4 = (LinearLayout) findViewById(R.id.s57_4);
        ...
        s57_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s57_1);// create's
        ...
        s57_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s57_2);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s57_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s57_3);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s57_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s57_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_book);
