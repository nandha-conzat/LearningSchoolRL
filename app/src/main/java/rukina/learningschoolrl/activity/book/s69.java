 ...
 */
public class s69 extends AppCompatActivity {

    ImageView next, back, home;
    private MediaPlayer mp;
    TextView dispaly, s69_1, s69_2, s69_3, s69_4, s69_5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s69);

        mp = new MediaPlayer();
        playTitle();

        s69_1 = (TextView) findViewById(R.id.s69_1);
        s69_2 = (TextView) findViewById(R.id.s69_2);
        s69_3 = (TextView) findViewById(R.id.s69_3);
        s69_4 = (TextView) findViewById(R.id.s69_4);
        s69_5 = (TextView) findViewById(R.id.s69_5);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s69_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s69.this);
        ...
        s69_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s69_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s69_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s69);// create's
