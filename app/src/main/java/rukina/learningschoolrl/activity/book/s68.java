 ...
 */
public class s68 extends AppCompatActivity {

    ImageView next, s68_1, s68_2, s68_3,back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s68);

        mp = new MediaPlayer();
        playTitle();

        s68_1 = (ImageView) findViewById(R.id.s68_1);
        s68_2 = (ImageView) findViewById(R.id.s68_2);
        s68_3 = (ImageView) findViewById(R.id.s68_3);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s68_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s68.this);
        ...
        s68_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s68);// create's
