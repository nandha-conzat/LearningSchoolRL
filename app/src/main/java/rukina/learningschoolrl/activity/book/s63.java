 ...
 */
public class s63 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s63_1, s63_2, s63_3;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s63);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s63_1 = (RelativeLayout) findViewById(R.id.s63_1);
        s63_2 = (RelativeLayout) findViewById(R.id.s63_2);
        s63_3 = (RelativeLayout) findViewById(R.id.s63_3);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s63_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass(s63.this);
        ...
        s63_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s63_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s63);// create's
