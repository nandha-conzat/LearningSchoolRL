 ...
 */
public class s67 extends AppCompatActivity {

    ImageView next, back, home;
    TextView s67_1, s67_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s67);

        mp = new MediaPlayer();
        playTitle();

        s67_1 = (TextView) findViewById(R.id.s67_1);
        s67_2 = (TextView) findViewById(R.id.s67_2);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s67.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s67);// create's
