 ...
 */
public class s50 extends AppCompatActivity {

    ImageView drag, next, back, home, empty;
    private MediaPlayer mp;
    RelativeLayout s50_1, s50_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drag = (ImageView) findViewById(R.id.drag_soap);
        s50_1 = (RelativeLayout) findViewById(R.id.s50_1);
        s50_2 = (RelativeLayout) findViewById(R.id.s50_2);
        empty = (ImageView) findViewById(R.id.drag_empty);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s50_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s50.this);
                        cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                        cdd.show();
                        empty.setImageResource(R.drawable.s50_1);
                        try {
...
//
        ...
        s50_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s50);// create's
