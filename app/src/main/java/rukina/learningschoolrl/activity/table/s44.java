 ...
 */
public class s44 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s44_1, s44_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s44);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s44_1 = (RelativeLayout) findViewById(R.id.s44_1);
        s44_2 = (RelativeLayout) findViewById(R.id.s44_2);
        ...
        s44_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s44.this);
        ...
        s44_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s44);// create's
