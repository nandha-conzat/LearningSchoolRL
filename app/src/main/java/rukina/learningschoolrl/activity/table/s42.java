 ...
 */
public class s42 extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout s42_1, s42_2;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s42);
        mp = new MediaPlayer();

        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s42_1 = (RelativeLayout) findViewById(R.id.s42_1);
        s42_2 = (RelativeLayout) findViewById(R.id.s42_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s42_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s42.this);
        ...
        s42_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s42);// create's
