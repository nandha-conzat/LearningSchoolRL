 ...
 */
public class s51 extends AppCompatActivity {

    ImageView next, s51_1, s51_2, s51_3, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s51_1 = (ImageView) findViewById(R.id.s51_1);
        s51_2 = (ImageView) findViewById(R.id.s51_2);
        s51_3 = (ImageView) findViewById(R.id.s51_3);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s51.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s51);// create's
