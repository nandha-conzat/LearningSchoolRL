 ...
 */
public class s56 extends AppCompatActivity {

    ImageView next, a, b, c, back, home;
    TextView option1, option2, option3, choice1, choice2, choice3;
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        if (userEntered.equals("A .B .C .")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s56.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s56);// create's
