 ...
 */
public class s52 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, s52_1, s52_2, s52_3, s52_4, s52_5, s52_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s52);
        mp = new MediaPlayer();
        playTitle();

        s52_1 = (TextView) findViewById(R.id.s52_1);
        s52_2 = (TextView) findViewById(R.id.s52_2);
        s52_3 = (TextView) findViewById(R.id.s52_3);
        s52_4 = (TextView) findViewById(R.id.s52_4);
        s52_5 = (TextView) findViewById(R.id.s52_5);
        s52_6 = (TextView) findViewById(R.id.s52_6);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s52_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s52.this);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s52_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s52_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s52);// create's
