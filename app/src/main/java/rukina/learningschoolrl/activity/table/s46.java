 ...
 */
public class s46 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout s46_1, s46_2, s46_3;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s46);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s46_1 = (RelativeLayout) findViewById(R.id.s46_1);
        s46_2 = (RelativeLayout) findViewById(R.id.s46_2);
        s46_3 = (RelativeLayout) findViewById(R.id.s46_3);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s46_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s46.this);
        ...
        s46_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s46_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s46);// create's
