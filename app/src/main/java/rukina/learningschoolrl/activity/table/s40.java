 ...
 */
public class s40 extends AppCompatActivity {

    private MediaPlayer mp;
    LinearLayout s40_1, s40_2, s40_3, s40_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s40);

        mp = new MediaPlayer();
        s40_1 = (LinearLayout) findViewById(R.id.s40_1);
        s40_2 = (LinearLayout) findViewById(R.id.s40_2);
        s40_3 = (LinearLayout) findViewById(R.id.s40_3);
        s40_4 = (LinearLayout) findViewById(R.id.s40_4);
        ...
        s40_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s40_1);// create's
        ...
        s40_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s40_2);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s40_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s40_3);// create's
                mp.start(); // starting mediaplayer
            }
        });

        s40_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s40_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_table);
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s40_5);// create's
        mp.start(); // starting mediaplayer
    }
