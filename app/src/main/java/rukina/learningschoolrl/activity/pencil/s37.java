 ...
 */
public class s37 extends AppCompatActivity {

    private TextView option1, option2, option3, option4, option5, option6, option7, choice1, choice2, choice3, choice4, choice5, choice6;
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String e = choice2.getText().toString().trim();
                        String n = choice3.getText().toString().trim();
                        String c = choice4.getText().toString().trim();
                        String i = choice5.getText().toString().trim();
                        String l = choice6.getText().toString().trim();

                        userEntered = "" + p + e + n + c + i + l;
                        if (userEntered.equals("p .e .n .c .i .l .")) {
                            playPerfect();
                            cdd = new CustomDialogClass(s37.this);
    ...
    public void reset(View view) {
        ...
        choice6.setTextColor(Color.TRANSPARENT);
