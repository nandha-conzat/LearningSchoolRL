 ...
 */
public class s32 extends AppCompatActivity {

    ImageView next, back, home;
    RelativeLayout s32_1, s32_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s32);
        mp = new MediaPlayer();
        playTitle();

        s32_1 = (RelativeLayout) findViewById(R.id.rl_s32_1);
        s32_2 = (RelativeLayout) findViewById(R.id.rl_s32_2);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s32.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s32);// create's
