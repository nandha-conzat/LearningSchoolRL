 ...
 */
public class s33 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, s33_1, s33_2, s33_3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s33);
        System.gc();

        mp = new MediaPlayer();
        playTitle();

        s33_1 = (TextView) findViewById(R.id.s33_1);
        s33_2 = (TextView) findViewById(R.id.s33_2);
        s33_3 = (TextView) findViewById(R.id.s33_3);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s33.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s33);// create's
