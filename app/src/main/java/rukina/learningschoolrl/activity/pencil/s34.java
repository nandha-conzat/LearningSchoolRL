 ...
 */
public class s34 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, s34_1, s34_2, s34_3, s34_4, s34_5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s34);
        mp = new MediaPlayer();
        playTitle();

        s34_1 = (TextView) findViewById(R.id.s34_1);
        s34_2 = (TextView) findViewById(R.id.s34_2);
        s34_3 = (TextView) findViewById(R.id.s34_3);
        s34_4 = (TextView) findViewById(R.id.s34_4);
        s34_5 = (TextView) findViewById(R.id.s34_5);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s34.this);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s34_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s34_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s34);// create's
