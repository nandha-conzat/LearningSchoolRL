 ...
 */
public class s35 extends AppCompatActivity {

    ImageView next, back, home;
    TextView dispaly, s35_1, s35_2, s35_3, s35_4, s35_5, s35_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s35);

        mp = new MediaPlayer();
        playTitle();

        s35_1 = (TextView) findViewById(R.id.s35_1);
        s35_2 = (TextView) findViewById(R.id.s35_2);
        s35_3 = (TextView) findViewById(R.id.s35_3);
        s35_4 = (TextView) findViewById(R.id.s35_4);
        s35_5 = (TextView) findViewById(R.id.s35_5);
        s35_6 = (TextView) findViewById(R.id.s35_6);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s35_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass(s35.this);
...
//                dispaly.setTextColor(Color.RED);
        ...
        s35_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
        ...
        s35_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s35);// create's
