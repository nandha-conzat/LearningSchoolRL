 ...
 */
public class s38 extends AppCompatActivity {
...
//                            startActivity(i);
                            ...
                            mp = MediaPlayer.create(getApplicationContext(), R.raw.s38_2);// create's
        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playPerfect();
                cdd = new CustomDialogClass(s38.this);
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s38_1);// create's
        mp.start(); // starting mediaplayer
    }
