package rukina.learningschoolrl.activity.pencil;
 ...
 */
public class s30 extends AppCompatActivity {

    ImageView next, back, home, s30_2, s30_3, s30_4, s30_5, s30_6, s30_7, s30_8, drag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s30);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s30_2 = (ImageView) findViewById(R.id.s30_2);
        s30_3 = (ImageView) findViewById(R.id.s30_3);
        s30_4 = (ImageView) findViewById(R.id.s30_4);
        s30_5 = (ImageView) findViewById(R.id.s30_5);
        s30_6 = (ImageView) findViewById(R.id.s30_6);
        s30_7 = (ImageView) findViewById(R.id.s30_7);
        s30_8 = (ImageView) findViewById(R.id.s30_8);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);

        s30_5.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s30.this);
...
//
        ...
        s30_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s30_3.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s30_4.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s30_6.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s30_7.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        s30_8.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s30);// create's
