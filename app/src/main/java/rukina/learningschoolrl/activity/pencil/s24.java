...
public class s24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s24);
        mp = new MediaPlayer();
        System.gc();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag);
        s24_1 = (RelativeLayout) findViewById(R.id.s24_1);
        s24_2 = (RelativeLayout) findViewById(R.id.s24_2);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.next);
        back = (ImageView) findViewById(R.id.back);
        home = (ImageView) findViewById(R.id.home);

        s24_1.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass(s24.this);
        ...
        s24_2.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s24);// create's
