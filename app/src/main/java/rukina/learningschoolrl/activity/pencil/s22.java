...
public class s22 extends AppCompatActivity {
    ...
    LinearLayout s22_1, s22_2, s22_3, s22_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = new MediaPlayer();
        s22_1 = (LinearLayout) findViewById(R.id.s22_1);
        s22_2 = (LinearLayout) findViewById(R.id.s22_2);
        s22_3 = (LinearLayout) findViewById(R.id.s22_3);
        s22_4 = (LinearLayout) findViewById(R.id.s22_4);
        ...
        s22_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s22_1);// create's
        ...
        s22_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s22_2);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s22_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s22_3);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        s22_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.s22_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_pencil);
